...
REPO_ID = "johwes/scar-gnn-defect-detector"

UPLOADS = [
    ("model.pt",         "model.pt",    "Block-level GNN classifier (57.84% Devign, pipeline deliverable)"),
    ("model_instr.pt",   "model_instr.pt", "Instruction-level GNN classifier (58.00% Devign)"),
